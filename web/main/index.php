...
<?php  include("head.php");  ?>
	<div class="container c_LogoRow">
		<!-- Website Content -->
		<div class="row">
			<div class="col text-center"><img class="rounded" src="https://gamerparty.eu/assets/gp_pride_big.gif" style="height: 350px; width: 350px;"></div>
	...
	<div class="container-fluid c_SticktoBottom pt-2" id="stream" style="background-color: black">
		<div class="row c_tableoverflow">
			<div class="col-lg-3 col-sm-0"></div>
			<div class="col-lg-6 col-sm-12">
				<?php include("php/stream.php");?>
			</div>
		</div>
	</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="card-body">
									...
									<p class="card-text"><i class="fas fa-hand-holding-heart" aria-hidden="true"></i> Current score: <?php echo $fah['score']; ?></p>
									<p class="card-text"><i class="fas fa-laptop-house" aria-hidden="true"></i> Current WU-count: <?php echo $fah['wu']; ?></p>
									<p class="card-text"><i class="fas fa-star" aria-hidden="true"></i> Global Rank: <?php echo $fah['rank']; ?></p>
