      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col">
            ...
            <h4>Impressum</h4>
<p>GamerParty<br />
E-Mail: <a id="mailtxt"><button onclick="showMail();">Anzeigen</button></a><br>
Website: www.gamerparty.eu</p>
<script>
            function showMail()
            {
                var txt = ":)";
                ...
                txt = t1 + t5 + t2;
                document.getElementById("mailtxt").innerHTML = txt;
            }
</script>

<p><strong>Verantwortlich für den Inhalt</strong> (gem. § 55 Abs. 2 RStV):<br />GamerParty</p>
<br /><h5>Disclaimer – rechtliche Hinweise</h5>
